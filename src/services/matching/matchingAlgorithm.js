...
function calculatePairwiseScore(studentA, studentB, weights, params) {
    ...
    if (params.includes('discussionQuestion')) {
        ...
        const sameQ = studentA.discussionQuestionId && studentB.discussionQuestionId && studentA.discussionQuestionId === studentB.discussionQuestionId ? 1 : 0;
...
function greedyTeamFormation(students, teamSize, matrix, params, weightExtro, globalExtroMean) {
    ...
    for (let t = 0; t < numTeams; t++) {
        ...
        // seed: best compatible candidate overall
        ...
        // grow: pick best candidate for current team
